class ChangeForeignKeysToUuid < ActiveRecord::Migration[5.1]
  def up
    id_to_uuid("repairs", "device", "device")
    id_to_uuid("repairs", "address", "address")
    id_to_uuid("repairs", "user", "user")
    id_to_uuid("addresses", "user", "user")
    id_to_uuid("devices", "user", "user")
  end
